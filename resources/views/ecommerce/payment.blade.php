			...
			<div class="row">
                ...
                @endif
                    <div class="row">
						<div class="col-md-12">
                            @if (auth()->guard('customer')->check())
                            <a href="{{ route('customer.view_order', request()->invoice) }}">
                            @else
                            <a href="{{ route('customer.view_order_unregistered', request()->invoice) }}">
                            @endif
                                <button class="btn btn-default btn-sm px-4 mb-4">Kembali</button>
                            </a>
							<div class="card">
								...
								<div class="card-body">
                                    ...
                                    @csrf
                                    @else
                                    <form action="{{ route('customer.savePayment_unregistered') }}" enctype="multipart/form-data" method="post">
                                    @csrf
                                    @endif

                                                    ...
                                                    <td>
                                                        <form action="{{ route('customer.order_accept') }}" 
                                                            ...
                                                            @if ($row->status == 3 && $row->return_count == 0)
                                                                <button class="btn btn-success btn-sm" onclick="return confirm('Terima Pesanan?')">Terima</button>
                                                                <a href="{{ route('customer.order_return', $row->invoice) }}" class="btn btn-danger btn-sm mt-1" onclick="return confirm('Kembalikan Pesanan?')">Return</a>
                                                            @endif
                                                        </form>
                                                    </td>
                                                </tr>
